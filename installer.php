...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240131_dryneedlingromania_94bc57d01f2470ef3142_20240131093223_archive.zip';
        const ARCHIVE_SIZE       = '523982078';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '94bc57d-31093223';
        const SECONDARY_PACKAGE_HASH = '18cb29b-31093223';
        const VERSION            = '1.5.8';
